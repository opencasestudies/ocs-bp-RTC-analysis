...
Hmm, bummer this is not in PMC for a free version.... MAT: I think we just remove this comment for now?
...
1. Data visualizations (`ggplot2`, `cowplot`).
2. Sampling subsets of data (`rsample`).

AVOCADO: I removed items 1-5 from the data science learning objectives, but was wondering if you should include a link to the wrangling case study here?
...
AVOCADO: is there another good motivation for converting the units like this? I think it is worth explaining as transformations/interpretability are important components of data science. MAT: I think it is fine as is for now.
...
avocadoPossible tutorials about plm: (not sure if we want to include or not -- MAT: I think we should, the latter is very good)  
